...
class Config:
    ...
    TEST_DIR = '/autograder/source/tests'  #  directory where all test directories reside
    BUILD_SOURCE_DIR = '/autograder/source/tests/student-src'  #  directory where all submitted files will reside
